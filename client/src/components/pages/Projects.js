  ...
  return (
    <div name="Projects" className="w-full h-screen bg-indigo-600 text-white">
      <div className="flex flex-col justify-center items-center w-full h-full">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-4 px-10">
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-blue-800">
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-blue-800 items-center">
            ...
            <img className="w-full max-h-64" src="./img/project-4-img.jpg" target="_blank" alt="TravAlot icon" />
