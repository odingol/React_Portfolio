    ...
    <div name="Projects" className="w-full h-screen bg-indigo-600 text-white pt-10">
      <div className="flex flex-col justify-center items-center w-full h-full p-15">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-5 px-14">
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-blue-800 max-h-90 m-2">
            <a href="https://github.com/odingol/Project-1-KrustyKrabs" target="_blank" rel="noreferrer">
            <img className="w-50" src="./img/project-1-img.jpg" alt="Krusty Krab icon" />
            <p className="my-5 text-xl">Krusty Krab</p>
            <p className="my-3 text-xl hover:text-orange-300"><a href="https://taylor25et.github.io/Project-1-KrustyKrabs/" target="_blank" rel="noreferrer">Deployed Site</a></p>
            </a>
          </div>
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-blue-800 max-h-90 m-2">
            <a href="https://github.com/odingol/code-quiz" target="_blank" rel="noreferrer">
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-blue-800 max-h-90 m-2">
            <a href="https://github.com/odingol/weather-dashboard" target="_blank" rel="noreferrer">
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-blue-800 items-center max-h-90 m-2">
            <a href="https://github.com/odingol/Project-2-Travel-App" target="_blank" rel="noreferrer">
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500 bg-blue-800 items-center">
            <a href="https://github.com/odingol/letstalktech" target="_blank" rel="noreferrer">
